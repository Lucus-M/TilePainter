...
export default class User {
    constructor(){
        ...
        this.brushRadius; this.setBrushRadius();
    ...
    updateMousePos(event){
        ...
        if(!((prevX === this.hoveredTile.x) && (prevY === this.hoveredTile.y))){
            ...
            if(this.tileSelector.selected != 0) this.canvas.drawCursorTiles(this.canvas.drawing(this.brushRadius, this.hoveredTile), this.tileSelector);
